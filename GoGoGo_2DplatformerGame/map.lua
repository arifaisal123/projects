...
local Enemy7 = require("enemy7")
local Enemy8 = require("enemy8")
local Enemy9 = require("enemy9")
...
function Map:spawnEntities()
    for i,v in ipairs(self.entityLayer.objects) do
        ...
        elseif v.class == "enemy7" then
            Enemy7.new(v.x + v.width / 2, v.y + v.height / 2)
        elseif v.class == "enemy8" then
            Enemy8.new(v.x + v.width / 2, v.y + v.height / 2)
        elseif v.class == "enemy9" then
            Enemy9.new(v.x + v.width / 2, v.y + v.height / 2)
        elseif v.class == "cookie" then
			Cookie.new(v.x, v.y)      
        end
    end
end
